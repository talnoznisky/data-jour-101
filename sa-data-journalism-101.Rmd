---
title: "A Beginner's Guide to Data Journalism attempt in R"
...
Just set up two custom functions to use later in an lapply and dplyr-chain
One function to strip commas from input and then convert to numeric
